...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(prefixService +"/src/main/java");
        // TODO 设置用户名
        gc.setAuthor(author);
        // service 命名方式TbAlbumService
        // service impl 命名方式
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPathService +"/src/main/resources/mapper/goods"
