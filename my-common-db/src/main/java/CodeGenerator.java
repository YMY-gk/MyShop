...
public class CodeGenerator {
     ...
     */
    private static String url="jdbc:mysql://182.254.221.85:3306/t_user?useUnicode=true&zeroDateTimeBehavior=convertToNull&characterEncoding=utf8";
    ...
    public static List getAllTableColumn() throws SQLException, ClassNotFoundException {
        ...
        //获得表信息
        ResultSet tables = metaData.getTables("t_user", "t_user", null, new String[]{"TABLE"});
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        String prefixDao = "/my-service-api/my-service-user-api";
        String prefixService = "/my-service/my-service-user";
        ...
        for (String table:list) {
            ...
            String xml = "/src/main/resources/mapper/user/";
            String java = "/src/main/java/com/me/user/";
            String parent = "com.me.user";
